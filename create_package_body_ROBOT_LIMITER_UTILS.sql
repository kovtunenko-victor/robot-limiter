...
BEGIN
  ...
  temp := PROC.ACQINFO_Q.GETDOCS(c_org_account, c_visa_account_oppo, to_date(for_date));
  temp := PROC.ACQINFO_Q.GETDOCS(c_visa_account_oppo, c_org_account, to_date(for_date));
    
  temp := PROC.ACQINFO_Q.GETDOCS(c_org_account, c_mc_account, to_date(for_date));
  temp := PROC.ACQINFO_Q.GETDOCS(c_mc_account, c_org_account, to_date(for_date));
  temp := PROC.ACQINFO_Q.GETDOCS(c_org_account, c_mc_account_oppo, to_date(for_date));
  temp := PROC.ACQINFO_Q.GETDOCS(c_mc_account_oppo, c_org_account, to_date(for_date));
    
  temp := PROC.ACQINFO_Q.GETDOCS(c_org_account, c_mir_account, to_date(for_date));
